...
def compare_excel_files(file1_path, file2_path):
    try:
        # Leer los archivos Excel, especificando las columnas D (RFC) y F (Descuento).
        df1 = pd.read_excel(file1_path, usecols=[3, 5], header=None, names=['RFC', 'Descuento'], skiprows=1)
